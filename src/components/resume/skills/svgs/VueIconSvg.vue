<template>
  <svg :style="iconStyle" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><title>
    file_type_vue</title>
...
export default {
  ...
  computed: {
    iconStyle() {
      return {
        width: `${this.$store.state.icons.skills.width} !important`,
        height: `${this.$store.state.icons.skills.height} !important`
      }
    }
  }
}
